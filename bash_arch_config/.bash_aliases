...
alias create_py_dir='bash ~/.config/bash_scripts/create_py_dir.sh'
alias create_py_file='bash ~/.config/bash_scripts/create_py_file.sh'     # Create a Python file
alias create_py_test='bash ~/.config/bash_scripts/create_py_test.sh'     # Create a Python test file
alias open_py_ide='bash ~/.config/bash_scripts/pyproject_tmux.sh'  # Open a tmux based ide
...
delete_py_dir() {                                           # Delete a Python project
	...
	if [ "$answer" != "${answer#[Yy]}" ] ; then
	    path=$HOME$"/Code_Dev/Python/"$varname
	    rm -r "$path"
